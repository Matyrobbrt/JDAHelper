...
public interface InteractionContext<T extends Interaction> {
    ...
    /**
     * Gets the {@link Component#uuid() ID} of the component.
     *
    ...
    /**
     * Updates the arguments of the {@link Component component} which is linked
    ...
    /**
     * Updates an argument of the {@link Component component} which triggered this interaction.
     *
