...
public record SelectMenuBuilder<T extends SelectMenu, B extends SelectMenu.Builder<T, B>>(ComponentListener listener, Creator<T, B> creator) {
     ...
     */
    @NotNull
    public B createMenu(@NotNull ComponentLifespan lifespan, final String... args) {
     ...
     */
    @NotNull
    public B createMenu(@NotNull ComponentLifespan lifespan, final List<String> args) {
     ...
     */
    @NotNull
    public B createMenu(@NotNull ComponentLifespan lifespan, final List<String> args, final Object... idArguments) {
        final var comp = new Component(listener.getName(), UUID.randomUUID(), args, lifespan);
        listener.insertComponent(comp);
