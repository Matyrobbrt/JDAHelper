...
import com.matyrobbrt.jdahelper.util.DismissListener;
...
public final class PaginatorImpl implements Paginator {
    ...
    private final ComponentLifespan lifespan;
    ...
    PaginatorImpl(final ComponentListener.Builder listener, @Nullable final Consumer<? super ButtonInteractionContext> buttonInteractionHandler, final ComponentLifespan lifespan, final int itemsPerPage, final boolean dismissible, final boolean buttonsOwnerOnly, final MessageGetter messageGetter, final ButtonFactory buttonFactory, final List<ButtonType> buttonOrder) {
    ...
    public MessageCreateBuilder getMessage(final int startingIndex, final int maximum, final List<String> arguments) {
        return messageGetter.getMessage(startingIndex, maximum, arguments);
    }
    ...
    @Override
    public ComponentLifespan getLifespan() {
        return lifespan;
    }
    ...
    public MessageCreateData createPaginatedMessage(final int startingIndex, final int maximum, final @Nullable Long messageOwner, final List<String> args) {
        ...
        final var component = new Component(getListener().getName(), id, argsList, getLifespan());
