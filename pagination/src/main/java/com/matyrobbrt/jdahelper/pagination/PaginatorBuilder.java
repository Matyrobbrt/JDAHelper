...
public class PaginatorBuilder {
    ...
    private ComponentLifespan lifespan = ComponentLifespan.temporary();
     ...
     */
    public PaginatorBuilder lifespan(@NotNull final ComponentLifespan lifespan) {
        this.lifespan = Objects.requireNonNull(lifespan, "component lifespan must not be null");
        return this;
    }
    ...
    public PaginatorBuilder message(@NotNull final Paginator.MessageGetter messageGetter) {
        this.messageGetter = Objects.requireNonNull(messageGetter, "message getter must not be null");
        return this;
    }
    ...
    public PaginatorBuilder buttonFactory(@NotNull final Paginator.ButtonFactory factory) {
        this.buttonFactory = Objects.requireNonNull(factory, "button factory must not be null");
        return this;
    }
    ...
    public PaginatorBuilder buttonOrder(@NotNull final List<Paginator.ButtonType> order) {
        this.buttonOrder = Objects.requireNonNull(order, "order must not be null");
