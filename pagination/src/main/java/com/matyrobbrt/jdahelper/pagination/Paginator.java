...
import com.matyrobbrt.jdahelper.util.SelfFunctions;
...
public interface Paginator extends SelfFunctions<Paginator> {
    /**
     * The default {@linkplain ButtonFactory button factory}.
     */
    ...
    /**
     * The default order of the buttons. This includes the following buttons, in the following order:
     * <ul>
     *     <li>{@link ButtonType#PREVIOUS}</li>
     *     <li>{@link ButtonType#DISMISS}</li>
     *     <li>{@link ButtonType#NEXT}</li>
     * </ul>
     */
    List<ButtonType> DEFAULT_BUTTON_ORDER = List.of(ButtonType.PREVIOUS, ButtonType.DISMISS, ButtonType.NEXT);

    /**
     * The "natural" order of the buttons. This includes all the buttons, in the following order:
     * <ul>
     *     <li>{@link ButtonType#FIRST}</li>
     *     <li>{@link ButtonType#PREVIOUS}</li>
     *     <li>{@link ButtonType#DISMISS}</li>
     *     <li>{@link ButtonType#NEXT}</li>
     *     <li>{@link ButtonType#LAST}</li>
     * </ul>
     */
     ...
     */
    default ComponentLifespan getLifespan() {
